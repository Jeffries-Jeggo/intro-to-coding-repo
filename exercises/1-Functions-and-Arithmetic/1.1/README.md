# Exercise 1.1: Calling Built-in Functions

## Objectives
Learn to call Python's built-in functions like print(), max(), and min(). Understand that functions take inputs (arguments) and produce outputs.

## Task
In this exercise you'll practice calling Python's built-in functions.
